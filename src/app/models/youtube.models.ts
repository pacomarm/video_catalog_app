// To parse this data:
//
//   import { Convert, Yt } from "./file";
//
//   const yt = Convert.toYt(json);
//
...
export class Convert {
    public static toYt(json: string): YoutubeResponse {
        return cast(JSON.parse(json), r('Yt'));
    }

    public static ytToJson(value: YoutubeResponse): string {
        return JSON.stringify(uncast(value, r('Yt')), null, 2);
    }
}
